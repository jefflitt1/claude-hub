...
export const CORE_FUNCTIONS: RpcFunction[] = [
  {
    name: 'exec_sql',
 ...
 */
export function validateRpcFunction(name: string): boolean {
 ...
 */
export function suggestSimilarFunctions(name: string): string[] {

...
function routeAccount(params) {
    ...
    const defaultAcc = DEFAULT_ACCOUNT;
    return {
        account: defaultAcc,
...
// Tools
server.tool("message_send", "Send an email with automatic account routing based on context", sendMessageSchema, async (args) => {
    try {
...
server.tool("message_list", "List recent messages from one or both email accounts", listMessagesSchema, async (args) => {
    try {
...
server.tool("message_search", "Search for messages across email accounts", searchMessagesSchema, async (args) => {
    try {
...
server.tool("message_get", "Get full details of a specific message", getMessageSchema, async (args) => {
    try {
...
server.tool("contact_resolve", "Resolve a contact identifier to an email address and suggest the appropriate account", resolveContactSchema, async (args) => {
    try {
...
server.tool("comms_oauth_setup", "Set up or complete OAuth authentication for an email account", oauthSetupSchema, async (args) => {
    try {
...
server.tool("message_reply", "Reply to an email message (stays in same thread)", {
...
// Get thread tool
server.tool("message_thread", "Get all messages in a thread", {
...
// Trash messages tool
server.tool("message_trash", "Move messages to trash", {
...
server.tool("message_mark_read", "Mark messages as read (removes UNREAD label)", {
...
// Info tool
server.tool("comms_info", "Get information about unified communications configuration and status", {}, async () => {
